...
submitButton.addEventListener("click", async (event) => {
  ...
  try {
    ...
    const apiUrl = `${baseUrl}/hackathon/register`;
    ...
    if (responseData) {
      resultMessage.textContent = `${responseData.first_name} your request has been recieved we will get in touch with you soon`;
